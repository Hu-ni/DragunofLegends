...
public class PlayerControl : MonoBehaviour
{
    ...
    private AnimationHandler animationHandler; // AnimationHandler 스크립트 참조
    ...
    void Awake()
    {
        ...
        animationHandler = GetComponent<AnimationHandler>(); // 같은 오브젝트에 있는 AnimationHandler 컴포넌트 가져오기
    }
